...
/// <summary>
/// Retry politikasını SADECE <see cref="IndependentTeacherRegisteredConsumer"/>'a scope'lar.
...
/// </summary>
public class IndependentTeacherRegisteredConsumerDefinition : ConsumerDefinition<IndependentTeacherRegisteredConsumer>
{
    protected override void ConfigureConsumer(
        IReceiveEndpointConfigurator endpointConfigurator,
        IConsumerConfigurator<IndependentTeacherRegisteredConsumer> consumerConfigurator,
