...
namespace ExamApp.Api.Migrations
{
    ...
    [Migration("20260924224325_AddTestInstanceQuestionsAnsweredUpdateTimeIndex")]
    partial class AddTestInstanceQuestionsAnsweredUpdateTimeIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ExamApp.Api.Data.AdminDataAccessLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<string>("ActorKeycloakId")
                        .IsRequired()
                        .HasMaxLength(64)
                    ...
                    b.Property<bool>("UnassignedFilter")
                    ...
                    b.HasIndex("ActorKeycloakId", "OccurredAtUtc");

                    b.ToTable("AdminDataAccessLogs");
                });

            modelBuilder.Entity("ExamApp.Api.Data.AdminUserActionLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ExamApp.Api.Data.RecurringAvailabilityRule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("TeacherId", "DayOfWeek", "StartTime", "EndTime", "EffectiveFrom")
                        .IsUnique()
                        .HasFilter("\"IsActive\" AND NOT \"IsDeleted\"");

                    b.ToTable("RecurringAvailabilityRules");
                });
            ...
            modelBuilder.Entity("ExamApp.Api.Data.Teacher", b =>
                {
                    ...
                    b.Property<int?>("RequestedSchoolId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ExamApp.Api.Data.TeacherAvailabilitySlot", b =>
                {
                    ...
                    b.Property<int?>("RecurringAvailabilityRuleId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("RecurringAvailabilityRuleId", "Date");
            ...
            modelBuilder.Entity("ExamApp.Api.Data.TopicStudyLink", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("SubTopicId", "IsActive");

                    b.HasIndex("TopicId", "SubTopicId", "IsActive");

                    b.ToTable("TopicStudyLinks", t =>
                        {
            ...
            modelBuilder.Entity("WorksheetInstanceQuestion", b =>
                {
                    ...
                    NpgsqlIndexBuilderExtensions.IncludeProperties(b.HasIndex("UpdateTime"), new[] { "WorksheetInstanceId", "IsCorrect", "TimeTaken" });
            ...
            modelBuilder.Entity("ExamApp.Api.Data.Teacher", b =>
                {
                    b.HasOne("ExamApp.Api.Data.School", "RequestedSchool")
                        .WithMany()
                        .HasForeignKey("RequestedSchoolId")
            ...
            modelBuilder.Entity("ExamApp.Api.Data.TeacherAvailabilitySlot", b =>
                {
                    b.HasOne("ExamApp.Api.Data.RecurringAvailabilityRule", "RecurringAvailabilityRule")
                        .WithMany("GeneratedSlots")
                        .HasForeignKey("RecurringAvailabilityRuleId")
                        .OnDelete(DeleteBehavior.ClientNoAction);
                    ...
                    b.Navigation("RecurringAvailabilityRule");
