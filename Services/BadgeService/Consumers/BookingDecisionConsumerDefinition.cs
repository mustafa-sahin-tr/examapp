...
/// <summary>
/// Retry politikasını SADECE <see cref="BookingDecisionConsumer"/>'a scope'lar.
...
/// </summary>
public class BookingDecisionConsumerDefinition : ConsumerDefinition<BookingDecisionConsumer>
{
    protected override void ConfigureConsumer(
        IReceiveEndpointConfigurator endpointConfigurator,
        IConsumerConfigurator<BookingDecisionConsumer> consumerConfigurator,
