...
public class AdminControllerDashboardTrendsTests
{
    ...
    private AdminController NewController() => new(_taxonomy, _classifierCache, _schools, _dashboard, _locations, _teacherApprovals, _adminTeachers, _adminStudents, Substitute.For<IAdminDataAccessAuditService>(), Substitute.For<IAdminPasswordResetService>(), Substitute.For<IAdminAccountStatusService>());
